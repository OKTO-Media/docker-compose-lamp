...
<head>
    ...
    <title>Privacy Policy | OKTO Media - A New Site</title>
...
<body>
    ...
    <?php
        $companyName = 'OKTO Media';
        $companyWebsite = 'https://oktomedia.scot';
        $companyEmail = 'info@oktomedia.scot';
        $companyAddress = '3 Castle Court, Carnegie Campus, Dunfermline, KY11 8PB';
        $contactPageUrl = 'https://oktomedia.scot/contact';
    ?>
    <section>
        <div class="flexContainer">
            <h1>Privacy Policy</h1>
        </div>
        <div class="flexContainer vertical">
            <p>This Privacy Policy describes Our policies and procedures on the
                collection, use and
                disclosure of Your information when You use the Service and tells You about Your privacy
                rights and how
                the law protects You.<br><br>We use Your Personal data to provide and improve the
                Service. By using the
                Service, You agree to the collection and use of information in accordance with this
                Privacy Policy.
            </p>
            <h2>Interpretation</h2>
            <p>The words of which the initial letter is capitalised have meanings defined under the following
            ...
            <ul>
                ...
                <li>Usage Data refers to data collected automatically, either generated by the
                    ...
                    duration of a page
                    visit).</li>
                <li>Website refers to <?= $companyName ?>, accessible from
                    <a href="<?= $companyWebsite ?>" target="_blank"><?= $companyWebsite ?></a>
                </li>
                <li>You means the individual accessing or using the Service, or the company, or
                    other legal
            ...
            <h2>Collecting and Using Your Personal Data</h2>
                ...
                <h4>Usage Data</h4>
                <p>Usage Data is collected automatically when using the Service.Usage Data may include
                    information
                ...
                <p>If You decide to register through or otherwise grant us access to a Third-Party
                    ...
                    Your contact list
                    associated with that account.You may also have the option of sharing additional
                    ...
                    the Company
                    permission to use, share, and store it in a manner consistent with this Privacy
                    Policy.</p><br>
                ...
                <ul>
                    <li>Cookies or Browser Cookies. A cookie is a small file placed on Your Device.
                        ...
                        Service. Unless you have
                        adjusted Your browser setting so that it will refuse Cookies, our
                        Service may use
                        Cookies.</li>
                    <li>Flash Cookies. Certain features of our Service may use local stored objects
                        (or Flash
                        ...
                        <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_"
                            target="_blank"><span>https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</span></a>
                    </li>
                ...
                <p>Cookies can be “Persistent” or “Session” Cookies. Persistent Cookies remain on Your
                    personal
                    computer or mobile device when You go offline, while Session Cookies are deleted
                    as soon as You
                    close Your web browser. You can learn more about cookies here:<span class="text-span-2"></span>
                    <a href="https://www.termsfeed.com/privacy-policy-generator/#faq-8" target="_blank"><span>Cookies by TermsFeedGenerator</span></a><span>.</span>
                    We use both Session and Persistent Cookies for the purposes set out below:
                </p>
                <ul>
                    <li>Necessary / Essential CookiesType: Session CookiesAdministered by:
                        UsPurpose: These Cookies
                        are essential to provide You with services available through the Website
                    ...
                    <li>Cookies Policy / Notice Acceptance CookiesType: Persistent
                        CookiesAdministered by:
                        UsPurpose: These Cookies identify if users have accepted the use of
                        cookies on the
                        Website.</li>
                    <li>Functionality CookiesType: Persistent CookiesAdministered by: UsPurpose:
                        These Cookies allow
                ...
                <p>For more information about the cookies we use and your choices regarding cookies,
                    please visit
                    our Cookies Policy or the Cookies section of our Privacy Policy.</p><br>
                ...
                <ul>
                    ...
                    <li> With other users: when You share personal information or otherwise interact
                        ...
                        through a Third-Party Social
                        Media Service, Your contacts on the Third-Party Social Media Service may
                ...
                <p> Your information, including Personal Data, is processed at the Company’s operating
                    ...
                    laws may differ than
                    those from Your jurisdiction.Your consent to this Privacy Policy followed by
                    Your submission of such
                ...
                <p> If the Company is involved in a merger, acquisition or asset sale, Your Personal Data
                    may be
                    transferred. We will provide notice before Your Personal Data is transferred and
                    becomes subject to
                    a different Privacy Policy. </p><br>
                ...
                <p> Our Service does not address anyone under the age of 13. We do not knowingly collect
                    ...
                    verification of
                    parental consent, We take steps to remove that information from Our servers.If
                    We need to rely on
                    consent as a legal basis for processing Your information and Your country
                    requires consent from a
                ...
                <p> We may update Our Privacy Policy from time to time. We will notify You of any changes
                    ...
                    Service, prior to the change becoming effective and update the “Last updated”
                    date at the top of
                    this Privacy Policy.You are advised to review this Privacy Policy periodically
                    for any changes.
                ...
                <ul>
                    ...
                    <li> By visiting this page on our website: <span>
                        </span>
                        <a href="<?= $contactPageUrl ?>" target="_blank"><span><?= $contactPageUrl ?></span></a>
                    </li>
                </ul>
        </div>
    </section>
